...
using System;
namespace Soenneker.Stytch.OpenApiClient.V1.Idp.Oauth.Authorize.Start
{
    /// <summary>
    /// Builds and executes requests for operations under \v1\idp\oauth\authorize\start
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class StartRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Stytch.OpenApiClient.V1.Idp.Oauth.Authorize.Start.StartRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public StartRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/idp/oauth/authorize/start", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Stytch.OpenApiClient.V1.Idp.Oauth.Authorize.Start.StartRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public StartRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/idp/oauth/authorize/start", rawUrl)
        {
        }
        /// <summary>
        ...
        /// <exception cref="global::Soenneker.Stytch.OpenApiClient.Models.ApiIdpV1IdpOAuthAuthorizeStart401Response">When receiving a 401 status code</exception>
        /// <exception cref="global::Soenneker.Stytch.OpenApiClient.Models.ApiIdpV1IdpOAuthAuthorizeStart429Response">When receiving a 429 status code</exception>
        /// <exception cref="global::Soenneker.Stytch.OpenApiClient.Models.ApiIdpV1IdpOAuthAuthorizeStart500Response">When receiving a 500 status code</exception>
...
#nullable restore
        ...
        public async Task<global::Soenneker.Stytch.OpenApiClient.Models.ApiIdpV1IdpOAuthAuthorizeStartResponse> PostAsync(global::Soenneker.Stytch.OpenApiClient.Models.ApiIdpV1IdpOAuthAuthorizeStartRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "401", global::Soenneker.Stytch.OpenApiClient.Models.ApiIdpV1IdpOAuthAuthorizeStart401Response.CreateFromDiscriminatorValue },
                { "429", global::Soenneker.Stytch.OpenApiClient.Models.ApiIdpV1IdpOAuthAuthorizeStart429Response.CreateFromDiscriminatorValue },
                { "500", global::Soenneker.Stytch.OpenApiClient.Models.ApiIdpV1IdpOAuthAuthorizeStart500Response.CreateFromDiscriminatorValue },
            };
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Stytch.OpenApiClient.V1.Idp.Oauth.Authorize.Start.StartRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Stytch.OpenApiClient.V1.Idp.Oauth.Authorize.Start.StartRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Stytch.OpenApiClient.V1.Idp.Oauth.Authorize.Start.StartRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
