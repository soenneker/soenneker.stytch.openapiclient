...
namespace Soenneker.Stytch.OpenApiClient.V1.B2b.Scim.Item.Connection
{
    ...
    public partial class ConnectionRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <exception cref="global::Soenneker.Stytch.OpenApiClient.Models.ApiB2BScimV1B2BScimConnectionGet401Response">When receiving a 401 status code</exception>
        /// <exception cref="global::Soenneker.Stytch.OpenApiClient.Models.ApiB2BScimV1B2BScimConnectionGet429Response">When receiving a 429 status code</exception>
        /// <exception cref="global::Soenneker.Stytch.OpenApiClient.Models.ApiB2BScimV1B2BScimConnectionGet500Response">When receiving a 500 status code</exception>
...
#nullable restore
        ...
        public async Task<global::Soenneker.Stytch.OpenApiClient.Models.ApiB2BScimV1B2BScimConnectionGetResponse> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "401", global::Soenneker.Stytch.OpenApiClient.Models.ApiB2BScimV1B2BScimConnectionGet401Response.CreateFromDiscriminatorValue },
                { "429", global::Soenneker.Stytch.OpenApiClient.Models.ApiB2BScimV1B2BScimConnectionGet429Response.CreateFromDiscriminatorValue },
                { "500", global::Soenneker.Stytch.OpenApiClient.Models.ApiB2BScimV1B2BScimConnectionGet500Response.CreateFromDiscriminatorValue },
            };
        ...
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="global::Soenneker.Stytch.OpenApiClient.Models.ApiB2BScimV1B2BScimConnectionCreate401Response">When receiving a 401 status code</exception>
        /// <exception cref="global::Soenneker.Stytch.OpenApiClient.Models.ApiB2BScimV1B2BScimConnectionCreate429Response">When receiving a 429 status code</exception>
        /// <exception cref="global::Soenneker.Stytch.OpenApiClient.Models.ApiB2BScimV1B2BScimConnectionCreate500Response">When receiving a 500 status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public async Task<global::Soenneker.Stytch.OpenApiClient.Models.ApiB2BScimV1B2BScimConnectionCreateResponse> PostAsync(global::Soenneker.Stytch.OpenApiClient.Models.ApiB2BScimV1B2BScimConnectionCreateRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>>
            {
                { "401", global::Soenneker.Stytch.OpenApiClient.Models.ApiB2BScimV1B2BScimConnectionCreate401Response.CreateFromDiscriminatorValue },
                { "429", global::Soenneker.Stytch.OpenApiClient.Models.ApiB2BScimV1B2BScimConnectionCreate429Response.CreateFromDiscriminatorValue },
                { "500", global::Soenneker.Stytch.OpenApiClient.Models.ApiB2BScimV1B2BScimConnectionCreate500Response.CreateFromDiscriminatorValue },
            };
