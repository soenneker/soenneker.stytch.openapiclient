...
namespace Soenneker.Stytch.OpenApiClient.V1.B2b.Scim.Item.Connection.Item.Rotate.Complete
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Stytch.OpenApiClient.V1.B2b.Scim.Item.Connection.Item.Rotate.Complete.CompleteRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <exception cref="global::Soenneker.Stytch.OpenApiClient.Models.ApiB2BScimV1B2BScimConnectionRotateComplete401Response">When receiving a 401 status code</exception>
        /// <exception cref="global::Soenneker.Stytch.OpenApiClient.Models.ApiB2BScimV1B2BScimConnectionRotateComplete429Response">When receiving a 429 status code</exception>
        /// <exception cref="global::Soenneker.Stytch.OpenApiClient.Models.ApiB2BScimV1B2BScimConnectionRotateComplete500Response">When receiving a 500 status code</exception>
...
#nullable restore
        ...
        public async Task<global::Soenneker.Stytch.OpenApiClient.Models.ApiB2BScimV1B2BScimConnectionRotateCompleteResponse> PostAsync(global::Soenneker.Stytch.OpenApiClient.Models.ApiB2BScimV1B2BScimConnectionRotateCompleteRequestRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "401", global::Soenneker.Stytch.OpenApiClient.Models.ApiB2BScimV1B2BScimConnectionRotateComplete401Response.CreateFromDiscriminatorValue },
                { "429", global::Soenneker.Stytch.OpenApiClient.Models.ApiB2BScimV1B2BScimConnectionRotateComplete429Response.CreateFromDiscriminatorValue },
                { "500", global::Soenneker.Stytch.OpenApiClient.Models.ApiB2BScimV1B2BScimConnectionRotateComplete500Response.CreateFromDiscriminatorValue },
            };
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Stytch.OpenApiClient.V1.B2b.Scim.Item.Connection.Item.Rotate.Complete.CompleteRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Stytch.OpenApiClient.V1.B2b.Scim.Item.Connection.Item.Rotate.Complete.CompleteRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Stytch.OpenApiClient.V1.B2b.Scim.Item.Connection.Item.Rotate.Complete.CompleteRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
