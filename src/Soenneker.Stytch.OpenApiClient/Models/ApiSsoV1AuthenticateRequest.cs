...
namespace Soenneker.Stytch.OpenApiClient.Models
{
    ...
    public partial class ApiSsoV1AuthenticateRequest : IAdditionalDataHolder, IParsable
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Soenneker.Stytch.OpenApiClient.Models.ApiSsoV1AuthenticateRequest_session_custom_claims? SessionCustomClaims { get; set; }
#nullable restore
#else
        public global::Soenneker.Stytch.OpenApiClient.Models.ApiSsoV1AuthenticateRequest_session_custom_claims SessionCustomClaims { get; set; }
#endif
        ...
        /// <summary>The `session_jwt` belonging to the member that you wish to associate the email with.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public string SessionJwt { get; set; }
#endif
        /// <summary>The `session_token` belonging to the member that you wish to associate the email with.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Stytch.OpenApiClient.Models.ApiSsoV1AuthenticateRequest"/> and sets the default values.
        /// </summary>
        public ApiSsoV1AuthenticateRequest()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Stytch.OpenApiClient.Models.ApiSsoV1AuthenticateRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Stytch.OpenApiClient.Models.ApiSsoV1AuthenticateRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Stytch.OpenApiClient.Models.ApiSsoV1AuthenticateRequest();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "session_custom_claims", n => { SessionCustomClaims = n.GetObjectValue<global::Soenneker.Stytch.OpenApiClient.Models.ApiSsoV1AuthenticateRequest_session_custom_claims>(global::Soenneker.Stytch.OpenApiClient.Models.ApiSsoV1AuthenticateRequest_session_custom_claims.CreateFromDiscriminatorValue); } },
                ...
                { "sso_token", n => { SsoToken = n.GetStringValue(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Soenneker.Stytch.OpenApiClient.Models.ApiSsoV1AuthenticateRequest_session_custom_claims>("session_custom_claims", SessionCustomClaims);
            ...
            writer.WriteStringValue("sso_token", SsoToken);
