...
namespace Soenneker.Stytch.OpenApiClient.Models
{
    ...
    public partial class ApiSsoV1SsoOidcUpdateConnectionResponse : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        /// <summary>If it is not possible to resolve the well-known metadata document from the OIDC issuer, this field will explain what went wrong if the request is successful otherwise. In other words, even if the overall request succeeds, there could be relevant warnings related to the connection update.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Stytch.OpenApiClient.Models.ApiSsoV1SsoOidcUpdateConnectionResponse"/> and sets the default values.
        /// </summary>
        public ApiSsoV1SsoOidcUpdateConnectionResponse()
        {
        ...
        public static global::Soenneker.Stytch.OpenApiClient.Models.ApiSsoV1SsoOidcUpdateConnectionResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Stytch.OpenApiClient.Models.ApiSsoV1SsoOidcUpdateConnectionResponse();
        }
        /// <summary>
