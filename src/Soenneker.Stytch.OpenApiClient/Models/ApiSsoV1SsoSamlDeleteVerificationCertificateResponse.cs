...
namespace Soenneker.Stytch.OpenApiClient.Models
{
    ...
    public partial class ApiSsoV1SsoSamlDeleteVerificationCertificateResponse : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>The ID of the certificate that was deleted.</summary>
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Stytch.OpenApiClient.Models.ApiSsoV1SsoSamlDeleteVerificationCertificateResponse"/> and sets the default values.
        /// </summary>
        public ApiSsoV1SsoSamlDeleteVerificationCertificateResponse()
        {
        ...
        public static global::Soenneker.Stytch.OpenApiClient.Models.ApiSsoV1SsoSamlDeleteVerificationCertificateResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Stytch.OpenApiClient.Models.ApiSsoV1SsoSamlDeleteVerificationCertificateResponse();
        }
        /// <summary>
